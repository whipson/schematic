...
schematic is an R package that makes it easy to validate a data.frame against a schema—checking column types, nullability, and more. It’s designed with user-facing applications in mind, providing clear and expressive error messages that help users understand and fix their data issues.
