...
- use of `tidyselect` syntax for declaring schema 
- user-facing messages that can be displayed in applications
- error messages display all schema failures, not just the first detected
